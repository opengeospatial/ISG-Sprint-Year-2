...
._Feature information in the RMTexture from Aden, Yemen CDB stored as TIFF. CDB was provided by Presagis._
...
._Using the CesiumJS renderer meshes from GeoTypical tree models are stored once and rendered from CDB of Aden, Yemen._
