...
Participants were free to use other data sets to provide the sufficient and necessary data for development and testing. Several participants did choose to use other data sets. The full list of data sets used along with other reference and meta-data information is provided in Annex **X**. The table below summarizes data set usages and the participants.

[#table_summary-datasets,reftext='{table-caption} {counter:table-num}']
.Data sets used by the participants. Details on each data set are provided in Annex **X**.
[cols="1,1,1,1,1,1,1",options="header",align="center"]
|===
|*Data set*|*Cesium*|*Ecere*|*FlightSafety*|*InfoDao*|*SimBblocks*|*Steimbeis*
|San Diego CDB| - |  - |  - |  - |  - |  - 
|New York CDB| - |  - |  - |  - |  - |  - 
|===
