...
[NOTE]
====
_I think that the use of a LHS for models needs to be explained since OpenFlight and glTF both use RHS._
====
...
.Aerial view of Germany's Baden-Wuerttemberg region (data Copyright &#169; OpenStreetMap contributors, Visible Earth Blue Marble from NASA and elevation data from Jonathan de Ferranti's ViewFinderPanorama (including data from SRTM, NASA / USGS)).
...
.View of 3D buildings (data Copyright &#169; OpenStreetMap contributors, Visible Earth Blue Marble from NASA and elevation data from Jonathan de Ferranti's ViewFinderPanorama (including data from SRTM, NASA / USGS)).
image::images/Ecere/HfT-osm-buildings.jpg[width=800,align="center"]

[#Ecere_HfT6,reftext='{figure-caption} {counter:figure-num}']
.Closer view of 3D buildings (data Copyright &#169; OpenStreetMap contributors, HfT building model provided by Steinbeis, Visible Earth Blue Marble from NASA and elevation data from Jonathan de Ferranti's ViewFinderPanorama (including data from SRTM, NASA / USGS)).
...
.View close to HfT building (data Copyright &#169; OpenStreetMap contributors, HfT building model provided by Steinbeis, Visible Earth Blue Marble from NASA and elevation data from Jonathan de Ferranti's ViewFinderPanorama (including data from SRTM, NASA / USGS)).
