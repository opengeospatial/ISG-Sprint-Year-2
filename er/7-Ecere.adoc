...
- the positive Z axis of the 3D model points Northwards for model formats using a right-handed coordinate system (such as E3D), but Southwards for model formats using a left-handed coordinate system (such as OpenFlight and glTF).
...
For roll, this follows the right-handed coordinate system rules as they align with the cardinal direction signs,
...
- the positive X axis of the 3D model points Eastwards,
- the positive Y axis of the 3D model points upwards away from the center of the Earth, and
- the positive Z axis of the 3D model points Southwards, since glTF models use a left-handed coordinate system
