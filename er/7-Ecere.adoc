...
[NOTE]
====
_It should be pointed out that this is *NOT* a right-handed coordinate system. This is a left-handed coordinate system, if possible please expand on why a left-hand system is used as a right-hand system is used in OpenFlight and glTF._
====
...
In CesiumJS setting the refinement method to `REPLACE` prevented refinement of the tileset, so that more detailed levels would never be requested. CesiumJS appears to not consider that all children were refined since one of them had no content specified at
...
._Awkward wording_
===============================================
The sentence that starts "In CesiumJS setting the refinement method..." is very awkward and needs to be rephrased. 
===============================================
