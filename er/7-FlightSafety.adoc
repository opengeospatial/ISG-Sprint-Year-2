...
image::images/FlightSafety/tree_visual.jpg[width=600,align="center"]

[#img_tree_nvg,reftext='{figure-caption} {counter:figure-num}']
.A model with Near Infrared texture
image::images/FlightSafety/tree_nvg.jpg[width=600,align="center"]
...
* glTF models would not be a good choice for a profile of CDB made for data repositories.  Most glTF models we found are lower quality conversions from other modeling formats
