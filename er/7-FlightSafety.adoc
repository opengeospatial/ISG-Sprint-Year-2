...
1. How to encode and store multi-spectral textures of wavelengths that are primarily reflective such as Near Infrared and Short Wave Infrared wavelengths (SWIR).  These are used for Night Vision Goggle (NVG) simulation and/or stimulation, and SWIR sensors.
...
[NOTE]
._It should be pointed out that the textures represent different tress and readers should not infer that differences in shape are not the result visual vs. near infrared responses._
===============================================
===============================================
...
[NOTE]
._Texture atlasing looks to be the same as UV texture mapping to a mesh. The UV mapping is done all the time and models that do not use that are generally considered faulty._
===============================================
===============================================
