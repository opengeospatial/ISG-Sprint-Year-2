...
._Bad Sentence_
===============================================
Half-way through the above paragraph the "sentence": "In the image below the vector layers for both the GeoSpecific and GeoTypical model layers." is not a complete sentence and needs to be removed or corrected. (Resolved)
===============================================
