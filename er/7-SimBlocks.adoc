...
[NOTE]
._You may want to indicate that the work was done according to the license of these libraries. I can avoid some uncertainity in understanding. For example you could append to the last sentence " consisten with their licenses"._
===============================================
===============================================
...
1. Conversion of CDB content into GeoPackage using glTF binary as model format.

1. 3d content creation directly into GeoPackage using glTF binary as the model format.

1. Capture performance metric of format choices using OSG software.

1. GeoPackage playback using the Unity Game Engine.

1. GeoPackage content conversion into Unreal Engine.

1. Our team now has a much better understanding of glTF.

1. utilized Unity’s “Advanced” Mesh API for better runtime performance.

1. Major software upgrade to improve support for CDB and GeoPackage in Unity.
...
.San Diego waterfront shown in Unreal
...
.Downtown San Dieo abd Coronado Bridge shown in OpenSceneGraph
...
[NOTE]
._The reference above needs to link to the correct section._
===============================================
===============================================

===== File size
For the example GeoPackage Tile LOD3 U5 R6 required 2,390,364 KB of disk space with OpenFlight models while it tool 34,583,256 KB of disk space with the glTF Binary files with embedded textures. This increased file size for the GeoPackage is a result of duplicating the texture content stored in the GTModels/GTModelTexture layer into many GLTF models as the San Diego CDB was created using only GeoTypical textures from this layer for both the GeoTypical and GeoSpecific models.
...
._The number of buildings loaded vs. the total load time shown for varying numbers of threads._
