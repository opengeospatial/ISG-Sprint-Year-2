...
* **InfoDao** displayed <<InfoDao-Scenario-3,results in Unity while investigating moving models>>. Additional testing is needed to determine suitability for this use in real-world applications.
...
2. Additional testing of the proposed extensions is needed. This is to determine if the extensions cover the capabilities of OpenFlight as used in a CDB datastore.
