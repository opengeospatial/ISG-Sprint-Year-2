...
Introductory text for InfoDao, Sections in this document should be no less than H3 (3 '=' signs). 
...
All images for this section go in link:images/InfoDao[InfoDao's image folder].
